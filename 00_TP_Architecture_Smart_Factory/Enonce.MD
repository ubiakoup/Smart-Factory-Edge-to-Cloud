...
* mettre en place une architecture IoT industrielle
...
* stockées
* visualisées
* et au possible exploitées dans le cloud

Dans ce projet, nous allons construire une **plate forme IIoT** complète pour le monitoting industriel en temps réel.
